...
public class frmIngreso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabelPatente, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 220, 530, 80));
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 80, 550, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Axion-Logo-web-250x100.png"))); // NOI18N
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 490, 250, 100));
        ...
        panelOculto1.add(registroPatente, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 310, -1));

        jPanel2.add(panelOculto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 430, 360, 30));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/combustibles-alternativos80.jpg"))); // NOI18N
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -140, 800, 870));

        getContentPane().add(jPanel2);
        jPanel2.setBounds(-90, 10, 1690, 820);
